...
if __name__ == '__main__':
    ...
    while True:
        try:
            response = json.loads(requests.get('https://service.ecojoko.com/gateway/7716/device/56238/realtime_conso', headers=headers, cookies=cookies).content.decode('UTF-8'))
